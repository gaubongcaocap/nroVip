...
public enum PetType {
    ...
    MABU        (1,  "Mabư",         1500000, "Oa oa oa...",                 Kind.MABU,   6, 3, false, null),
    BEERUS      (2,  "Beerus Hắc Ám",       1500000, "Thần hủy diệt hiện thân tất cả quỳ xuống...", Kind.BEERUS, 6, 3, false, null),
    PIC         (3,  "Pic",          1500000, "Sư Phụ SooMe hiện thân tụi m quỳ xuống...",   Kind.PIC,    6, 3, false, null),
    BLACK       (4,  "Black Hắc Ám",        1500000, "Ta sẽ cho người biết sức mạnh của một vị thần là như thế nào !", Kind.BLACK, 6, 3, false, null),
    ...
    public enum Kind { NORMAL, MABU, BEERUS, PIC, BLACK, NHI, SUPER }
    ...
    public static PetType byId(int id) {
        for (PetType t : values()) if (t.id == id) return t;
        return NORMAL;
    }
}
