...
public class Map22hService {

    private static Map22hService instance;

    public static Map22hService gI() {
        if (Map22hService.instance == null) {
            Map22hService.instance = new Map22hService();
        }
        return Map22hService.instance;
    }

    public List<RedRibbonHQ> doanhTrais;

    private Map22hService() {
