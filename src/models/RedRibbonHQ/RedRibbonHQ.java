...
import boss.Boss;
import boss.list.RedRibbonHQ.NinjaAoTim;
import boss.list.RedRibbonHQ.RobotVeSi;
import boss.list.RedRibbonHQ.TrungUyThep;
import boss.list.RedRibbonHQ.TrungUyTrang;
import boss.list.RedRibbonHQ.TrungUyXanhLo;
import clan.Clan;
import map.Zone;
import mob.Mob;
...
public class RedRibbonHQ implements Runnable {
    ...
    private void init() {
        ...
        for (Zone zone : this.zones) {
            ...
            long dame = totalHp / 40; // giảm sát thương của boss
            long hp = totalDamage * 25; // giảm HP của boss
    ...
    public void updateHPDame() {
        ...
        long dame = totalHp / 40;
        long hp = totalDame * 25;
