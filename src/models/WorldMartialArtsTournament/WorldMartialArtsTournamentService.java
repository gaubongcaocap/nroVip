...
//        }
        if (!WorldMartialArtsTournamentManager.gI().listReg.contains(player.id)) {
            ...
            if (baseValue < 1500000) {
                ...
                // Chỉ có thể đăng ký giải Ngoại hạng
                if (tour != NGOAI_HANG) {
