...
public class Zenitsu extends Boss {

    private long st;

    public Zenitsu() throws Exception {
        super(BossID.ZENITSU, false, false, BossesData.ZENITSU);
    }
    ...
    public void doneChatE() {
        ...
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if ((boss.id == BossID.INOSUKE_PIG || boss.id == BossID.INOSUKE || boss.id == BossID.NEZUKO) && !boss.isDie()) {
                return;
            }
        }
