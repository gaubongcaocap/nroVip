...
public class BossesData {
         ...
         */
        // private static final int[][] FULL_DRAGON = new int[][]{{Skill.DRAGON, 1},
        // {Skill.DRAGON, 2}, {Skill.DRAGON, 3}, {Skill.DRAGON, 4}, {Skill.DRAGON, 5},
        // {Skill.DRAGON, 6}, {Skill.DRAGON, 7}};
        ...
        private static final int[][] FULL_ANTOMIC = new int[][] { { Skill.ANTOMIC, 1 }, { Skill.ANTOMIC, 2 },
                        ...
                        { Skill.ANTOMIC, 7 } };
        // private static final int[][] FULL_LIENHOAN = new int[][]{{Skill.LIEN_HOAN,
        // 1}, {Skill.LIEN_HOAN, 2}, {Skill.LIEN_HOAN, 3}, {Skill.LIEN_HOAN, 4},
        // {Skill.LIEN_HOAN, 5}, {Skill.LIEN_HOAN, 6}, {Skill.LIEN_HOAN, 7}};
        ...
        // private static final int REST_24_H = 86_400;
        ...
        public static final BossData MAP_DAU_DINH = new BossData(
                        ...
                        new int[][] {
                                        ...
                                        { Skill.THAI_DUONG_HA_SAN, 4, 30000 },
        ...
        public static final BossData SO_2 = new BossData(
                        ...
                        new int[][] {
                                        ...
                                        { Skill.TAI_TAO_NANG_LUONG, 7, 20000 },
                                        { Skill.TROI, 3, 40000 },
                                        { Skill.ANTOMIC, 7, 2000 } }, // skill//skill
                        new String[] {}, // text chat 1
                        new String[] { "|-1|Oải rồi hả",
                                        "|-1|Ê cố lên nhóc",
                                        "|-1|Một mình tao chấp hết tụi bây",
        ...
        public static final BossData FIDE_DAI_CA_3 = new BossData(
                        ...
                        new int[][] {
                                        { Skill.MASENKO, 7, 1000 },
                                        { Skill.TAI_TAO_NANG_LUONG, 7, 20000 },
                                        { Skill.THAI_DUONG_HA_SAN, 4, 80000 },
        ...
        public static final BossData DR_KORE = new BossData(
                        ...
                        new String[] { "|-1|Oải rồi hả?",
                                        "|-1|Tao sẽ thấp thụ mọi đòn tấn công",
                                        "|-1|Ê cố lên nhóc",
                                        "|-1|Chán",
        ...
        public static final BossData APK20 = new BossData(
                        "Android 21",
                        ConstPlayer.TRAI_DAT,
                        new short[] { 249, 250, 251, -1, -1, -1 }, // outfit {head, body, leg, bag, aura, eff}
                        280_000,
                        new long[] { 1_000_000_000 }, // hp
                        new int[] { 29, 5, 33, 13, 20, 37 }, // map join
                        new int[][] { // skill
                                        { Skill.MASENKO, 7, 1000 },
                                        { Skill.KAMEJOKO, 7, 1000 },
                                        { Skill.ANTOMIC, 7, 1000 },
                                        { Skill.TAI_TAO_NANG_LUONG, 7, 20000 },
                                        { Skill.SOCOLA, 7, 20000 },
                                        { Skill.DRAGON, 7, 1000 },
                        ...
                        new String[] { "|-1|Oải rồi hả?",
                                        ...
                                        "|-1|Chán",
                                        "|-1|Ngươi sẽ không bao giờ thắng được đâu!!",
                                        "|-2|Ngươi không thể đánh bại được ta đâu", }, // text chat 2
                        new String[] {}, // text chat 3
                        REST_10_M, // second rest
                        new int[] { BossID.ANDROID_21 });
        ...
        public static final BossData PIC = new BossData(
                        ...
                        new int[][] {
                                        { Skill.SOCOLA, 7, 1000 },
                                        { Skill.MASENKO, 7, 1000 },
                                        { Skill.TAI_TAO_NANG_LUONG, 2, 20000 },
                                        { Skill.THOI_MIEN, 7, 50000 },
                                        { Skill.KHIEN_NANG_LUONG, 2, 60000 },
                                        { Skill.GALICK, 7, 1000 }, }, // skill
        ...
        public static final BossData POC = new BossData(
                        ...
                        new int[][] {
                                        { Skill.SOCOLA, 7, 1000 },
                                        { Skill.KHIEN_NANG_LUONG, 3, 60000 },
                                        { Skill.MASENKO, 7, 1000 },
        ...
        public static final BossData XEN_BO_HUNG_2 = new BossData(
                        ...
                        300_000,
                        new long[] { 600_000_000 },
                        new int[] { 98, 99, 100 },
                        new int[][] {
                                        { Skill.SOCOLA, 7, 1000 },
                                        { Skill.TAI_TAO_NANG_LUONG, 7, 20000 },
                                        { Skill.THAI_DUONG_HA_SAN, 7, 40000 },
                                        { Skill.KHIEN_NANG_LUONG, 4, 120000 },
        ...
        public static final BossData XEN_BO_HUNG_3 = new BossData(
                        ...
                        300_000,
                        new long[] { 700_000_000 },
                        new int[] { 98, 99, 100 },
                        new int[][] {
                                        { Skill.SOCOLA, 7, 1000 },
                                        { Skill.TAI_TAO_NANG_LUONG, 7, 20000 },
                                        { Skill.THAI_DUONG_HA_SAN, 7, 40000 },
                                        { Skill.KHIEN_NANG_LUONG, 5, 120000 },
                                        { Skill.KAMEJOKO, 7, 5000 },
                                        { Skill.LIEN_HOAN, 7, 500 } }, // skill
        ...
        public static final BossData GOKU_HUYDIET = new BossData(
                        "Goku Xì Ke", // name
                        ConstPlayer.XAYDA, // gender
                        new short[] { 101, 65, 66, -1, 1, -1 }, // outfit {head, body, leg, bag, aura, eff}
                        300_000, // dame
                        ...
                        new String[] {
                                        "|-1|Bạn không chơi đồ thì không hiểu được đâu",
                                        "|-2|Trời ơi...Hắn định giết mọi người ở đây chắc?",
                                        "|-1|Tao sẽ hủy diệt cả cái làng này",
                                        "|-1|Chỉ toàn lũ gà!",
                                        "|-1|Có trình không",
                                        "|-2|Goku tỉnh lại đi!",
                                        "|-1|Tụi mày chỉ là lũ kém cỏi",
                                        "|-2|Goku! dừng tay lại! Cậu điên mất rồi!",
                                        "|-1|Đêm nay tao sẽ mở liên hoan xác thịt",
        ...
        public static final BossData CADIC_HUYDIET = new BossData(
                        ...
                        new String[] {
                                        ...
                                        "|-2|2 thằng này chơi đồ à",
                                        "|-1|Chỉ toàn lũ gà!",
                                        "|-1|Biết Hái Thứ Hiêu không",
                                        "|-2|Cadic tỉnh lại đi!",
                                        "|-1|Tụi mày chỉ là lũ kém cỏi",
                                        "|-1|Tao sẽ hóa vàng tất cả",
                                        "|-2|Goku tỉnh lại đi!", }, // text chat 2
        ...
        public static final BossData TAN_BINH_5 = new BossData(
                        ...
                        new int[][] {
                                        ...
                                        { Skill.ANTOMIC, 1, 1000 },
                                        { Skill.KAMEJOKO, 1, 1000 },
                                        { Skill.LIEN_HOAN, 1, 1000 }, // {Skill.BIEN_KHI, 6, 3000000},
                        }, // skill
                        new String[] {}, // text chat 1
                        new String[] { "|-1|Khí công pháo" }, // text chat 2
                        new String[] {}, // text chat 3
        ...
        public static final BossData AN_TROM = new BossData(
                        ...
                        new String[] { "|-1|Tới giờ làm việc, lụm lụm",
                                        "|-1|Cảm giác mình vào phải khu người nghèo :))" }, // text
                                                                                            // chat
                                                                                            // 1
        ...
        // "Broly", // name
        // ConstPlayer.XAYDA, // gender
        // new short[] { 291, 292, 293, -1, -1, -1 }, // outfit {head, body, leg, bag,
        // aura, eff}
        // 100, // dame
        // new long[] { 10_000 }, // hp
        ...
        // },
        // { Skill.GALICK, 7, 1000 },
        // { Skill.KAMEJOKO, 1, 1000 }, { Skill.KAMEJOKO, 2, 1000 }, { Skill.KAMEJOKO,
        // 3, 1000 },
        // { Skill.KAMEJOKO, 4, 1000 }, { Skill.KAMEJOKO, 5, 1000 }, { Skill.KAMEJOKO,
        // 6, 1000 },
        // { Skill.KAMEJOKO, 7, 1000 },
        // { Skill.MASENKO, 1, 1000 }, { Skill.MASENKO, 2, 1000 }, { Skill.MASENKO, 3,
        // 1000 },
        // { Skill.MASENKO, 4, 1000 }, { Skill.MASENKO, 5, 1000 }, { Skill.MASENKO, 6,
        // 1000 },
        // { Skill.MASENKO, 7, 1000 },
        // { Skill.ANTOMIC, 1, 1000 }, { Skill.ANTOMIC, 2, 1000 }, { Skill.ANTOMIC, 3,
        // 1000 },
        // { Skill.ANTOMIC, 4, 1000 }, { Skill.ANTOMIC, 5, 1000 }, { Skill.ANTOMIC, 6,
        // 1000 },
        // { Skill.THAI_DUONG_HA_SAN, 7, 50000 },
        // { Skill.ANTOMIC, 7, 1000 }, }, // skill
        // new String[] {}, // text chat 1
