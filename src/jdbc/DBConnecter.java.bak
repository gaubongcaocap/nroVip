...
public class DBConnecter {
    ...
    private static String DB_HOST = "103.200.23.98";
    private static String DB_PORT = "3306";
    public static String DB_DATA = "dragons2_voz";
    public static String DB_USER = "dragons2_server";
    private static String DB_PASSWORD = "QW;VgoqI@.rjJGYoq)";
...
//            DB_SERVER = properties.getProperty("database.server", DB_SERVER);
            ...
            Logger.warning(" __      ______ ______  _              _____  ____  _    _ _      __  __       _______ ______ \n");
            Logger.warning(" \\ \\    / / __ \\___  / | |            / ____|/ __ \\| |  | | |    |  \\/  |   /\\|__   __|  ____|\n");
            Logger.warning("  \\ \\  / / |  | | / /  | |__  _   _  | (___ | |  | | |  | | |    | \\  / |  /  \\  | |  | |__   \n");
            Logger.warning("   \\ \\/ /| |  | |/ /   | '_ \\| | | |  \\___ \\| |  | | |  | | |    | |\\/| | / /\\ \\ | |  |  __|  \n");
            Logger.warning("    \\  / | |__| / /__  | |_) | |_| |  ____) | |__| | |__| | |____| |  | |/ ____ \\| |  | |____ \n");
            Logger.warning("     \\/   \\____/_____| |_.__/ \\__, | |_____/ \\____/ \\____/|______|_|  |_/_/    \\_\\_|  |______|\n");
            Logger.warning("                               __/ |                                                           \n");
            Logger.warning("                              |___/                                                            \n");
            ...
            // Logging successful message with color formatting
            Logger.log("[0;32m", "Successfully loaded file properties!\n");
