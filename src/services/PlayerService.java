...
public class PlayerService {
    ...
    public void sendTNSM(Player player, byte type, long param) {
        ...
        try {
            ...
            while (remaining > 0) {
                ...
                msg.writeLongBySoulmate(Util.maxIntValue(part), cn.readInt);
    ...
    public void sendInfoHp(Player player) {
        ...
        try {
            ...
            msg.writeLongBySoulmate(Util.maxIntValue(player.nPoint.hp),cn.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writeLongBySoulmate(Util.maxIntValue(player.nPoint.mp),cn.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writeLongBySoulmate(Util.maxIntValue(player.nPoint.hp),cn.readInt);//chp
            msg.writeLongBySoulmate(Util.maxIntValue(player.nPoint.mp),cn.readInt);//cmp
